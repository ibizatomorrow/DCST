...
class AGCRN(nn.Module):
    ...
    def get_args(self):
        file_path = "../STGNN/pemsbay/AGCRN/pemsbay.yaml"
        ...
        self.input_dim = cfg_gwnet.get("input_dim")
        self.hidden_dim = cfg_gwnet.get("hidden_dim")
        self.output_dim = cfg_gwnet.get("output_dim")
        self.horizon = cfg_gwnet.get("horizon")
        self.num_layers = cfg_gwnet.get("num_layers")
        self.default_graph = cfg_gwnet.get("default_graph")
        self.embed_dim = cfg_gwnet.get("embed_dim")
        self.cheb_k = cfg_gwnet.get("cheb_k")