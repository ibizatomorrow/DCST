...
class DCST(nn.Module):
    def __init__(
        ...
        #DCST
        self.attn_layers_t_revised = TemporalATT(self.model_dim, self.ST_scale, feed_forward_dim, num_heads, dropout)
        self.attn_layers_s_revised = Spatial_ATT(self.model_dim, self.ST_scale, feed_forward_dim, num_heads, dropout)
